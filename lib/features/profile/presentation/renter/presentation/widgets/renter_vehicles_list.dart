                  ...
                  children: [
                    Column(
                      children: vehicles
                          .asMap()
                          .entries
                          .take(10) // Limit to first 10 vehicles
                          .map(
                            (entry) => VehicleCard(
                              entry: entry,
                              onTap: isLoading
                                  ...
                                  : () async {
                                      ...
                                      try {
                                        final token = mainState.accessToken;
                                        await context
                                            .read<AddVehicleCubit>()
                                            .getData(entry.value.id.toString(),
                                                token)
                                            .timeout(
                    ...
                    if (vehicles.length >=
                        10) // Show button only if more than 10 vehicles
                      SeeMoreButton(
                        onPressed: () {
                          Navigator.push(
                            context,
