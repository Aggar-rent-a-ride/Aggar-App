...
class AllVehicleCategoryBody extends StatelessWidget {
  const AllVehicleCategoryBody({
    super.key,
    required this.cubit,
  ...
  final AllVehiclesCategoryScreen widget;
  ...
  Widget build(BuildContext context) {
    return RefreshIndicator(
      onRefresh: () async {
        cubit.fetchAllVehicles(widget.accessToken);
      },
