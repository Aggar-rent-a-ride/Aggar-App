...
import 'package:aggar/features/main_screen/customer/presentation/widgets/all_vehicle_category_body.dart';
...
class AllVehiclesCategoryScreen extends StatefulWidget {
  final String accessToken;

  const AllVehiclesCategoryScreen({required this.accessToken, super.key});

  @override
  State<AllVehiclesCategoryScreen> createState() =>
      _AllVehiclesCategoryScreenState();
}

class _AllVehiclesCategoryScreenState extends State<AllVehiclesCategoryScreen> {
  ...
  void _onScroll() {
    if (_isBottom && _cubit != null) {
      _cubit!.loadMoreVehicles(widget.accessToken);
    }
  }
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) {
        _cubit = VehicleCubit()..fetchAllVehicles(widget.accessToken);
        return _cubit!;
      },
      child: Scaffold(
